...
from new_qkmeans.qkmeans import QKMeans
...
# Plot the results
colors = ['royalblue', 'orangered', 'mediumseagreen']
for i in range(X_train.shape[0]):
    plt.scatter(X_train[i, 0], X_train[i, 1], color=colors[qkmeans.labels_[i]], marker='x', s=200)
plt.scatter(qkmeans.cluster_centers_[:, 0], qkmeans.cluster_centers_[:, 1],
            marker='+', c='darkorchid', s=350, linewidths=2.4)
plt.show()
